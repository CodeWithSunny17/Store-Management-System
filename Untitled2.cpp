	...
	if(acc == 1){
		...
		if(user == "Saurabh" && pwd == "Saurabh@124"){
			...
			if(opt == 1){
				...
				opt.open("OnePlus_6T.txt", ios::in | ios::out);
    			opt>>o1;
    			opt.close();
    			opt.open("Google_Pixel_3.txt", ios::in | ios::out);
    			opt>>o2;
    			opt.close();
    			opt.open("iPhone_XS_Max.txt", ios::in | ios::out);
    			opt>>o3;
    			opt.close();
    			opt.open("Samsung_Galaxy_S9_Plus.txt", ios::in | ios::out);
    			opt>>o4;
    			opt.close();
    			opt.open("Mi_A2.txt", ios::in | ios::out);
    			opt>>o5;
    			opt.close();
    			opt.open("Honor_View_20.txt", ios::in | ios::out);
    			opt>>o6;
    			opt.close();
    			opt.open("Huawei_Mate_20_Pro.txt", ios::in | ios::out);
    			opt>>o7;
    			opt.close();
    			opt.open("Samsung_Galaxy_S10_Plus.txt", ios::in | ios::out);
    			opt>>o8;
    			opt.close();
    			opt.open("iPhone_XS.txt", ios::in | ios::out);
    			opt>>o9;
    			opt.close();
    			opt.open("LG_V40_ThinQ.txt", ios::in | ios::out);
    			opt>>o10;
    			opt.close();
    			...
    			cout<<"---------TV Stock------------\n\nProduct Name\t\t\tQuantity\n\n----------------------------------\n\n";
				opt.open("LG_OLED55C8PTA.txt", ios::in | ios::out);
    			opt>>p1;
    			opt.close();
    			opt.open("Samsung_NU8000.txt", ios::in | ios::out);
    			opt>>p2;
    			opt.close();
    			opt.open("Sony_XBR55X900F.txt", ios::in | ios::out);
    			opt>>p3;
    			opt.close();
    			opt.open("TCL_55.txt", ios::in | ios::out);
    			opt>>p4;
    			opt.close();
    			opt.open("VIZIO_65.txt", ios::in | ios::out);
    			opt>>p5;
    			opt.close();
    			...
    			cout<<"---------Laptop Stock------------\n\nProduct Name\t\t\t\tQuantity\n\n----------------------------------\n\n";
				opt.open("Alienware_AAW17R4-7002SLV-PUS.txt", ios::in | ios::out);
    			opt>>i1;
    			opt.close();
    			opt.open("Predator_Helios_500.txt", ios::in | ios::out);
    			opt>>i2;
    			opt.close();
    			opt.open("MSI_Gaming.txt", ios::in | ios::out);
    			opt>>i3;
    			opt.close();
    			opt.open("Asus_ROG.txt", ios::in | ios::out);
    			opt>>i4;
    			opt.close();
    			opt.open("HP_OMEN.txt", ios::in | ios::out);
    			opt>>i5;
    			opt.close();
				...
				opt.open("JBL_Boom.txt", ios::in | ios::out);
    			opt>>i1;
    			opt.close();
    			opt.open("Beats_Studio3.txt", ios::in | ios::out);
    			opt>>i2;
    			opt.close();
    			opt.open("Skullcandy_Hesh.txt", ios::in | ios::out);
    			opt>>i3;
    			opt.close();
    			opt.open("boAt_600.txt", ios::in | ios::out);
    			opt>>i4;
    			opt.close();
    			opt.open("Apple_AirPods.txt", ios::in | ios::out);
    			opt>>i5;
    			opt.close();
		...
		PlaySound(TEXT("cat.wav"), NULL, SND_SYNC);
		cout<<"1. Mobiles"<<endl;
		cout<<"2. T.V"<<endl;
		cout<<"3. Laptops"<<endl;
		...
		if(x==1){
			...
			if(a1==1){
    			...
    			write.open("OnePlus_6T.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
				...
				clrscr();
				x = x - y;
				write.open("OnePlus_6T.txt", ios::out);
				write<<x;
 				write.close();
 				write.open("11_q.txt", ios::out);
 				write<<y;
 				write.close();
 				write.open("11_q.txt", ios::in);
 				write.close();
				if(x <= -1){
			...
			//Second item....
	        	...
	        	int x, p = 59189;
				int y;
    			write.open("Google_Pixel_3.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Google_Pixel_3.txt", ios::out);
				write<<x;
				if(x <= -1){
    		...
    		//Third item....
	        	...
	        	int x, p = 123500;
				int y;
    			write.open("iPhone_XS_Max.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("iPhone_XS_Max.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Fourth item....
	        	...
	        	int x, p = 64900;
				int y;
    			write.open("Samsung_Galaxy_S9_Plus.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Samsung_Galaxy_S9_Plus.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Fifth item....
	        	...
	        	int x, p = 11999;
				int y;
    			write.open("Mi_A2.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
    		...
    		//Sixth item....
	        	...
	        	int x, p = 37999;
				int y;
    			write.open("Honor_View_20.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Honor_View_20.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Seventh item....
	        	...
	        	int x, p = 64990;
				int y;
    			write.open("Huawei_Mate_20_Pro.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Huawei_Mate_20_Pro.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Eight item....
	        	...
	        	int x, p = 73900;
				int y;
    			write.open("Samsung_Galaxy_S10_Plus.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Samsung_Galaxy_S10_Plus.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Ninth item....
	        	...
	        	int x, p = 99900;
				int y;
    			write.open("iPhone_XS.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("iPhone_XS.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Tenth item....
	        	...
	        	int x, p = 49990;
				int y;
    			write.open("LG_V40_ThinQ.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("LG_V40_ThinQ.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
			...
			PlaySound(TEXT("TV.wav"), NULL, SND_SYNC);
			...
			if(a1==1){
	        	...
	        	int x, p = 151743;
				int y;
    			write.open("LG_OLED55C8PTA.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("LG_OLED55C8PTA.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
			...
			//Second item....
	        	...
	        	int x, p = 121989;
				int y;
    			write.open("Samsung_NU8000.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Samsung_NU8000.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Third item....
	        	...
	        	int x, p = 126058;
				int y;
    			write.open("Sony_XBR55X900F.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Sony_XBR55X900F.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Fourth item....
	        	...
	        	int x, p = 56786;
				int y;
    			write.open("TCL_55.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
    		...
    		//Fifth item....
	        	...
	        	int x, p = 117595;
				int y;
    			write.open("VIZIO_65.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("VIZIO_65.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
			...
			PlaySound(TEXT("laptop.wav"), NULL, SND_SYNC);
			...
			//Second item....
	        	...
	        	int x;
				 float p = 41080;
				int y;
    			write.open("Beats_Studio3.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Beats_Studio3.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Third item....
				...
				clrscr();
				x = x - y;
				write.open("Skullcandy_Hesh.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Fourth item....
	        	...
	        	int x, p = 2274;
				int y;
    			write.open("boAt_600.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("boAt_600.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
    		...
    		//Fifth item....
	        	...
	        	int x, p = 12999;
				int y;
    			write.open("Apple_AirPods.txt", ios::in | ios::out);
    			write>>x;
    			x=x;
    			write.close();
    			cout<<"Enter the Quantity : ";
				...
				clrscr();
				x = x - y;
				write.open("Apple_AirPods.txt", ios::out);
				write<<x;
				if(x <= -1){
					cout<<"you don't have enough item\n";
					exit(0);
